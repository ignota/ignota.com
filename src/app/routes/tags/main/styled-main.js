...
export const FeaturedTag = styled.article`
  padding: ${ halfGutter() };
`
...
export const SupportingTag = styled.article`
  display: grid;
...
export const TagDescription = styled.section`
  align-items: stretch;
  display: flex;
  flex-direction: column;
...
export const TagHero = styled.header`
  align-items: flex-end;
  display: flex;
  grid-column: 1 / -1;
  grid-row: 1 / span 1;
...
export const TagMedia = styled.div`
  display: grid;
